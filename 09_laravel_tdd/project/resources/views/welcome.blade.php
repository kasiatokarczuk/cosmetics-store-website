...
<!-- Navigation -->
<nav class="bg-pink-400 p-4">
    <div class="container mx-auto flex justify-between items-center">
        <a class="text-white text-lg font-bold" href="#">GlaMour</a>
        <ul class="flex space-x-4">
            <li><a class="text-white hover:text-pink-400" href="#">Nowości</a></li>
            <li><a class="text-white hover:text-gray-400" href="#">Promocje</a></li>
            <li><a class="text-white hover:text-gray-400" href="#">Makijaż</a></li>
            <li><a class="text-white hover:text-gray-400" href="#">Pielęgnacja</a></li>
            <li><a class="text-white hover:text-gray-400" href="#">Poradniki</a></li>
        </ul>
        <ul class="flex space-x-4">
            <li><a class="text-white hover:text-gray-400" href="#">Koszyk (0)</a></li>
        </ul>
    </div>
</nav>
...
<section class="hero-section">
    <h1 class="display-4">Zdjecia przesuwane </h1>
...
<section class="newsletter">
    ...
    <form>
        <div class="mb-3">
            <input type="email" class="form-control" placeholder="Wpisz swój e-mail">
        </div>
